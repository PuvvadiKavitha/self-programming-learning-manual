#include "MyWidget05.h"
#include <QVBoxLayout>
#include <QHBoxLayout>
#include <QSqlRecord>
#include <QCompleter>
#include <QDebug>
MyWidget05::MyWidget05(QWidget *parent) :
    QWidget(parent)
{
...
void MyWidget05::slotFilterChanged(QString filter)
{
    if(filter.isEmpty())
    {
        _model->setFilter("");
...
void MyWidget05::slotModelDataChanged(QModelIndex,QModelIndex)
{
    QStringList strList;
